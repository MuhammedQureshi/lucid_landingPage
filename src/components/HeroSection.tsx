    ...
    <section className='relative h-screen flex flex-coljustify-center'>
        ...
        <div className='flex flex-col items-center gap-24'>
            <div className='flex flex-col items-center gap-8'>
                ...
                <p className=''>Redefining the future of SUVs</p>
                <button className='bg-white hover:bg-slate-200 text-black uppercase px-6 py-2 rounded-md'>Stay informed</button>
            </div>
